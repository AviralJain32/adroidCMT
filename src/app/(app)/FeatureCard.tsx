...
const features = [
  ...
  // },
  {
    ...
    description: "Stay informed with automated notifications for important updates and deadlines. Our system keeps you and your participants in the loop with timely reminders.",
...
export function FeatureCard() {
  return (
    <div className="container mx-auto px-4 py-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {features.map((feature, index) => (
          <Card key={index} className="bg-gradient-to-br from-white to-gray-50 shadow-lg rounded-xl border border-gray-200 hover:shadow-2xl transition-shadow duration-300 p-6">
            <CardHeader className="flex items-center space-x-4">
              {feature.icon}
              <CardTitle className="text-xl font-bold text-gray-800">{feature.title}</CardTitle>
            </CardHeader>
